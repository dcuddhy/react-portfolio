                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <p>As a former photographer, I have a great eye for detail.  I love putting a polish on projects.  I can produce beautiful mockups or execute pixel perfect pages and components from your designer's vision.</p>
                        </div>
